...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [
            ...
            InlineKeyboardButton("📚 Koorsoota", callback_data="courses")
        ],
        [
            InlineKeyboardButton("💳 Kaffaltii", callback_data="payment"),
            InlineKeyboardButton("📤 Receipt", callback_data="receipt")
        ],
        [
        ...
        [
            ...
            InlineKeyboardButton("ℹ️ Waa'ee ELBS", callback_data="about")
        ]
    ]
